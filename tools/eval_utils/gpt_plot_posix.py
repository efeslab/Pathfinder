...
checkmark = plt.imread('/home/yilegu/squint/pm-cc-bug-finder/tools/eval_utils/checkmark.png')
crossmark = plt.imread('/home/yilegu/squint/pm-cc-bug-finder/tools/eval_utils/crossmark.png')

data = {
    "LevelDB": {
        "0": { # Missing fsync after MANIFEST creation, /home/yilegu/squint/pm-cc-bug-finder/build/leveldb_bug_0_before
            "exhaustive": [2, 0],
            "rep": [2, 0]
        },
        "1": { # Missing fsync when switching MANIFEST
            "exhaustive": [10, 0],
            "rep": [1, 0]
        },
        "2": { # Rename and unlink reorder
            "exhaustive": [1, 0],
            "rep": [1, 0]
        },
    },
    "RocksDB": { 
        "0": { # SetCurrentFile, /home/yilegu/squint/pm-cc-bug-finder/build/rocksdb_bug_1_full_scale_Jun_20
            "exhaustive": [15, 0],
            "rep": [1, 0]
        },
    },
    "WiredTiger": { # fake data
        "0": {
            "exhaustive": [10, 0],
            "rep": [1, 0]
        },
...
# Adjust layout
plt.tight_layout()
fig.savefig('crash_states_posix.pdf')
plt.show()
